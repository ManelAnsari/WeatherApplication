package com.formalab.weatherapplication;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadWeatherByCityName(final String city) {
        ...
        String apiUrl = "http://api.openweathermap.org/data/2.5/weather?q=" + city + "&units=metric&appid=df07195ad38e7d3cbb2f448d3aec3285";
